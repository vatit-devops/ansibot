...
Write-Verbose "UAC Disabled."

Write-VerboseLog "PS Remoting has been successfully configured for Ansible."

$restartAfterInstall = Read-Host -Prompt "Restart your computer now? [y]"
If ($restartAfterInstall -like "y") {
    Write-Verbose "Restarting Now."
    Restart-Computer
} Else {
    Write-Verbose "Restart for changes to take effect."
}
